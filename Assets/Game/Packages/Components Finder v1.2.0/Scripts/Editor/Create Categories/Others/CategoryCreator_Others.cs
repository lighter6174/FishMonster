...
{
	public class CategoryCreator_Others 
	{
		...
		public static void ConfigureCategory ()
		{
			...
			_FoldoutInfos.Name = ComponentsFinderStrings.Others;
			_FoldoutInfos._ComponentInfos = new List <ComponentInfos> () 
			{
				new ComponentInfos (typeof (Collider), BoolOption.Adds3D),
				new ComponentInfos (typeof (Collider2D))
			}.ToArray ();
		}
